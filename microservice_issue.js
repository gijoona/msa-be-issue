...
const business = require('./modules/monolithic_issue.js'),
...
/**
  Issue 클래스
*/
class issue extends require('./server.js') {
  /**
    생성자
  */
  constructor () {
    ...
    super('issue',
      ...
      ['POST/issue', 'GET/issue/list', 'GET/issue/edit', 'GET/issue/hashinfo', 'PUT/issue', 'DELETE/issue']
    );
